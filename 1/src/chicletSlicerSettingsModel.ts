...
const valuePositionOptions: IEnumMember[] = [
    { displayName: "Visual_ValuePosition_Below", value: "Below" },
    { displayName: "Visual_ValuePosition_Right", value: "Right" },
]

const textAlignmentOptions: IEnumMember[] = [
    { displayName: "Visual_Text_Align_Left", value: "Left" },
    { displayName: "Visual_Text_Align_Center", value: "Center" },
    { displayName: "Visual_Text_Align_Right", value: "Right" },
]
...
export class SlicerTextCardSettings extends SimpleCard {
    ...
    wordWrap = new formattingSettings.ToggleSwitch({
        name: "wordWrap",
        displayNameKey: "Visual_Enable_WordWrap",
        value: true
    })

    labelTextAlign = new formattingSettings.ItemDropdown({
        name: "labelTextAlign",
        displayNameKey: "Visual_Label_Text_Align",
        items: textAlignmentOptions,
        value: textAlignmentOptions[1]
    });

    labelFontFamily = new formattingSettings.FontPicker({
        name: "labelFontFamily",
        displayNameKey: "Visual_Label_Font",
        value: "Arial"
    });

    showValue = new formattingSettings.ToggleSwitch({
        name: "showValue",
        displayNameKey: "Visual_Show_Value",
        value: true
    })

    valueFontColor = new formattingSettings.ColorPicker({
        name: "valueFontColor",
        displayNameKey: "Visual_Value_TextColor",
        value: { value: "#212121" }
    });

    valueFontSize = new formattingSettings.NumUpDown({
        name: "valueFontSize",
        displayNameKey: "Visual_Value_TextSize",
        value: TextSizeSettings.DefaultValue,
        options: {
            minValue: {
                type: powerbi.visuals.ValidatorType.Min,
    ...
    valueFontFamily = new formattingSettings.FontPicker({
        ...
        displayNameKey: "Visual_Value_Font",
        value: "Arial"
    });

    valuePosition = new formattingSettings.ItemDropdown({
        name: "valuePosition",
        displayNameKey: "Visual_Value_Position",
        items: valuePositionOptions,
        value: valuePositionOptions[0]
    });

    valueTextAlign = new formattingSettings.ItemDropdown({
        name: "valueTextAlign",
        displayNameKey: "Visual_Value_Text_Align",
        items: textAlignmentOptions,
        value: textAlignmentOptions[1]
    });

    valueSpacing = new formattingSettings.NumUpDown({
        name: "valueSpacing",
        displayNameKey: "Visual_Value_Spacing",
        value: 6,
        options: {
            minValue: {
                type: powerbi.visuals.ValidatorType.Min,
    ...
    cardSpacing = new formattingSettings.NumUpDown({
        name: "cardSpacing",
        displayNameKey: "Visual_Card_Spacing",
        value: 2,
        options: {
            minValue: {
                type: powerbi.visuals.ValidatorType.Min,
    ...
    slices = [this.textSize, this.labelFontFamily, this.tailoring, this.wordWrap, this.labelTextAlign, this.showValue, this.valueFontColor, this.valueFontSize, this.valueFontFamily, this.valuePosition, this.valueTextAlign, this.valueSpacing, this.height, this.width, this.background, this.transparency, this.selectedColor, this.hoverColor,
                this.unselectedColor, this.disabledColor, this.outlineColor, this.outlineWeight, this.fontColor, this.padding, this.cardSpacing, this.borderStyle]
    ...
    revertToDefaultDescriptors: [
        ...
        {
            objectName: "rows"
            propertyName: "valuePosition"
        }
        ,{
            objectName: "rows"
            propertyName: "valueTextAlign"
        },
        {
            objectName: "rows"
...
export class ChicletSlicerSettingsModel extends Model {
    ...
    setLocalizedOptions(localizationManager: ILocalizationManager) {
        ...
        this.setLocalizedDisplayName(valuePositionOptions, localizationManager);
        this.setLocalizedDisplayName(textAlignmentOptions, localizationManager);
